...
/* package */ class MockRestService implements Service {
    ...
    static {
        ...
        User jeanFrancois = new User("Jean-Francois");
        User jeanMarc = new User("Jean-Marc");
        User jeanCharles = new User("Jean-Marc");
        ...
        List<AmountByUser> amountPerUserGift1Room0 = new ArrayList<>();
        amountPerUserGift1Room0.add(new AmountByUser(jeanPierre, 4d));
        ...
        List<AmountByUser> amountPerUserGift2Room0 = new ArrayList<>();

        amountPerUserGift2Room0.add(new AmountByUser(jeanBernard, 120d));
        amountPerUserGift2Room0.add(new AmountByUser(jeanMarie, 85d));
        ...
        gift.setAmount(0);
        gift.setRemainder(0);
        List<AmountByUser> amountPerUserGift1Room1 = new ArrayList<>();
        amountPerUserGift1Room1.add(new AmountByUser(jeanFrancois, 0.95d));
        ...
        List<AmountByUser> amountPerUserGift2Room1 = new ArrayList<>();
        amountPerUserGift2Room1.add(new AmountByUser(jeanCharles, 135d));
        amountPerUserGift2Room1.add(new AmountByUser(jeanMarc, 42d));
        ...
        List<AmountByUser> amountPerUserGift1Room2 = new ArrayList<>();
        amountPerUserGift1Room2.add(new AmountByUser(jeanBernard, 110.30d));
        amountPerUserGift1Room2.add(new AmountByUser(jeanPierre, 95.40d));
